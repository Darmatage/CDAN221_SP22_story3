...
// ENCOUNTER AFTER CHOICE #1
			...
			ArtBG2.SetActive(true);
                ...
                Char1speech.text = "";
                Char2name.text = "";
                Char2speech.text = "You enter the classroom, eyes glancing your way. As you take a seat at your desk, there is a single wilted rose.";
        }
...
// FUNCTIONS FOR BUTTONS TO ACCESS (Choice #1 and switch scenes)
		...
		public void Choice1cFunct(){
                ...
                Char1speech.text = "";
                Char2name.text = "";
                Char2speech.text = "You bring the flower and put it into the trash.";
                primeInt = 199;
                Choice1c.SetActive(false);
                Choice1d.SetActive(false);
                nextButton.SetActive(true);
		...
		public void Choice1dFunct(){
                ...
                Char1speech.text = "";
                Char2name.text = "";
                Char2speech.text = "You take the flower and give it a smell. Although it's faint, it gives a gentle aroma.";
                primeInt = 199;
                Choice1c.SetActive(false);
                Choice1d.SetActive(false);
                nextButton.SetActive(true);
